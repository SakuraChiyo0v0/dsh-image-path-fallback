	...
	factory: (require) => {
		...
		*/
		...
		function ImageFallbackSettings({ rpcCall }) {
			...
			})) : (0, react.createElement)("div", null, (0, react.createElement)("div", { style: styles.field }, (0, react.createElement)("label", { style: styles.label }, "视觉子代理 Provider（留空自动选择）"), (0, react.createElement)("input", {
				style: styles.input,
				value: settings.visionProvider,
				placeholder: "留空 = 自动从系统模型里找第一个支持图片的",
				onChange: (e) => set({ visionProvider: e.target.value })
			})), (0, react.createElement)("div", { style: styles.field }, (0, react.createElement)("label", { style: styles.label }, "视觉子代理 Model（留空自动选择）"), (0, react.createElement)("input", {
				style: styles.input,
